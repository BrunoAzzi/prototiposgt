...
class gsp_formulariosgt_atendimentocreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/atendimento/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'atendimento.label', default: 'Atendimento'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
public static final long LAST_MODIFIED = 1430265983463L
