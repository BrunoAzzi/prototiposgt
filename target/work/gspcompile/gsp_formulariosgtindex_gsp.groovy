...
class gsp_formulariosgtindex_gsp extends GroovyPage {
...
invokeTag('captureHead','sitemesh',96,[:],1)
printHtmlPart(4)
createTagBody(1, {->
printHtmlPart(5)
invokeTag('message','g',98,['code':("default.link.skip.label"),'default':("Skip to content&hellip;")],-1)
printHtmlPart(6)
...
invokeTag('link','g',130,['controller':(c.logicalPropertyName)],3)
printHtmlPart(21)
}
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1430422444008L
