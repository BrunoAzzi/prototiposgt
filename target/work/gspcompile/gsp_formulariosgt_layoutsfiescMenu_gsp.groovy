...
class gsp_formulariosgt_layoutsfiescMenu_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/layouts/fiescMenu.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(6)
invokeTag('image','asset',20,['src':("logoinstitutos.png"),'alt':("SENAI")],-1)
printHtmlPart(7)
...
public static final long LAST_MODIFIED = 1430421340925L
