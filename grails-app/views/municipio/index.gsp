		...
		<div id="list-municipio" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descricao" title="${message(code: 'municipio.descricao.label', default: 'Descricao')}" />
					
						<g:sortableColumn property="unidadeFederativa" title="${message(code: 'municipio.unidadeFederativa.label', default: 'Unidade Federativa')}" />
					
						<th><g:message code="municipio.regiao.label" default="Regiao" /></th>
				...
				<g:each in="${municipioInstanceList}" status="i" var="municipioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${municipioInstance.id}">${fieldValue(bean: municipioInstance, field: "descricao")}</g:link></td>
					
						<td>${fieldValue(bean: municipioInstance, field: "unidadeFederativa")}</td>
					
						<td>${fieldValue(bean: municipioInstance, field: "regiao")}</td>
