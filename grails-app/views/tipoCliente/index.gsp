		...
		<div id="list-tipoCliente" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descricao" title="${message(code: 'tipoCliente.descricao.label', default: 'Descricao')}" />
				...
				<g:each in="${tipoClienteInstanceList}" status="i" var="tipoClienteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tipoClienteInstance.id}">${fieldValue(bean: tipoClienteInstance, field: "descricao")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${tipoClienteInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
