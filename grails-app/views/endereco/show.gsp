	...
	<body>
		...
		<div id="show-endereco" class="content scaffold-show" role="main">
			...
			<ol class="property-list endereco">
				...
				<li class="fieldcontain">
					<span id="cliente-label" class="property-label"><g:message code="endereco.cliente.label" default="Cliente" /></span>
					
						<span class="property-value" aria-labelledby="cliente-label"><g:link controller="cliente" action="show" id="${enderecoInstance?.cliente?.id}">${enderecoInstance?.cliente?.encodeAsHTML()}</g:link></span>
