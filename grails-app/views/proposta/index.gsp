		...
		<div id="list-proposta" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descricao" title="${message(code: 'proposta.descricao.label', default: 'Descricao')}" />
				...
				<g:each in="${propostaInstanceList}" status="i" var="propostaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${propostaInstance.id}">${fieldValue(bean: propostaInstance, field: "descricao")}</g:link></td>
