		...
		<div id="list-skill" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descricao" title="${message(code: 'skill.descricao.label', default: 'Descricao')}" />
				...
				<g:each in="${skillInstanceList}" status="i" var="skillInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${skillInstance.id}">${fieldValue(bean: skillInstance, field: "descricao")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${skillInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
